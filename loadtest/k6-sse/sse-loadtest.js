...
export default function () {
    ...
    // ใช้ __ENV แบบที่รองรับโดย k6 (เพิ่ม global)
    const host = typeof __ENV !== 'undefined' ? __ENV.HOST || 'localhost' : 'localhost';
    const port = typeof __ENV !== 'undefined' ? __ENV.PORT || '8081' : '8081';
